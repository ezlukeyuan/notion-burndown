...
!function(e,t){if(true)module.exports=t();else { var i, r; }}(global,(function(){return(()=>{"use strict";var e={n:t=>{var r=t&&t.__esModule?()=>t.default:()=>t;return e.d(r,{a:r}),r},d:(t,r)=>{for(var i in r)e.o(r,i)&&!e.o(t,i)&&Object.defineProperty(t,i,{enumerable:!0,get:r[i]})},o:(e,t)=>Object.prototype.hasOwnProperty.call(e,t),r:e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})}},t={};e.r(t),e.d(t,{ImgurClient:()=>f,default:()=>m,getAuthorizationHeader:()=>a});const r=__nccwpck_require__(4351),i=__nccwpck_require__(8614),n="https://api.imgur.com";function a(e){return(0,r.__awaiter)(this,void 0,void 0,(function*(){if(void 0!==e.credentials.accessToken)return`Bearer ${e.credentials.accessToken}`;const{clientId:t,clientSecret:r,refreshToken:i}=e.credentials;if(void 0!==e.credentials.refreshToken){const a={url:"oauth2/token",baseURL:n,method:"POST",data:{client_id:t,client_secret:r,refresh_token:i,grant_type:"refresh_token"}},o=yield e.plainRequest(a);if(200===o.status&&o.data){const{access_token:t,refresh_token:r}=o.data;return e.credentials.accessToken=t,e.credentials.refreshToken=r,`Bearer ${t}`}}return function(e){return void 0!==e.clientId}(e.credentials)?`Client-ID ${t}`:null}))}const o=__nccwpck_require__(5234);var s=e.n(o);function d(e){const t=new(s());if("string"==typeof e)return t.append("image",e),t;for(const[r,i]of Object.entries(e)){const n=["base64","stream"];-1!==n.indexOf(r)?-1!==n.indexOf(e.type)&&t.append(r,e):t.append(r,i)}return t.getHeaders=t.getHeaders?t.getHeaders:()=>({"Content-Type":"multipart/form-data"}),t}function u(e){var t,r,i,n,a,o,s,d,u,c;let l,p=!0,h=200;const v=e&&(void 0!==e.status||void 0!==(null===(t=e.data)||void 0===t?void 0:t.status))&&void 0!==e.data,f=v&&!!e.data.success,m=v&&!f&&(void 0!==(null===(r=e.data.data)||void 0===r?void 0:r.error)||void 0!==e.data.errors);var g;return void 0===e?(l="response was empty",h=500,p=!1):"string"==typeof e?(l=e,h=500,p=!1):f?(h=e.data.status,l=e.data.data.error?e.data.data.error:e.data.data):(p=!1,h=null!==(o=null!==(a=null===(n=null===(i=e.data.data)||void 0===i?void 0:i.error)||void 0===n?void 0:n.code)&&void 0!==a?a:e.status)&&void 0!==o?o:e.data.status,g=m?null!==(d=null!==(s=e.data.errors)&&void 0!==s?s:e.data.data.error.message)&&void 0!==d?d:e.data.data.error:null!==(c=null!==(u=e.data.data)&&void 0!==u?u:e.data.message)&&void 0!==c?c:e.data,l=Array.isArray(g)?g.map((e=>m?e.detail:e.data)):g),{data:l,status:h,success:p}}const c=__nccwpck_require__(8835),l={section:"hot",sort:"viral"};const p=["q_all","q_any","q_exactly","q_not","q_type","q_size_px"];const h=__nccwpck_require__(6545);var v=e.n(h);class f extends i.EventEmitter{constructor(e){var t,i,o;super(),this.credentials=e,this.credentials.rapidApiHost=(null===(t=e.rapidApiKey)||void 0===t?void 0:t.length)?null!==(i=e.rapidApiHost)&&void 0!==i?i:"imgur-apiv3.p.rapidapi.com":e.rapidApiHost;const s="undefined"!=typeof window?{}:{"user-agent":"imgur (https://github.com/keneucker/imgur)"};this.plainFetcher=v().create({baseURL:n,headers:s,responseType:"json"}),this.fetcher=v().create({baseURL:(null===(o=e.rapidApiKey)||void 0===o?void 0:o.length)?`https://${this.credentials.rapidApiHost}`:n,headers:s,responseType:"json"}),this.fetcher.interceptors.request.use((t=>(0,r.__awaiter)(this,void 0,void 0,(function*(){var r;return t.headers=t.headers?t.headers:{},t.headers.authorization=yield a(this),(null===(r=e.rapidApiKey)||void 0===r?void 0:r.length)&&(t.headers["x-rapidapi-host"]=e.rapidApiHost,t.headers["x-rapidapi-key"]=e.rapidApiKey),t}))),(e=>Promise.reject(e)))}plainRequest(e){return this.plainFetcher(e)}request(e={}){return this.fetcher(e)}deleteImage(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const r=`3/image/${t}`;return u(yield e.request({url:r,method:"DELETE"}).catch((e=>e.response)))}))}(this,e)}favoriteImage(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const r=`3/image/${t}/favorite`;return u(yield e.request({url:r,method:"POST"}).catch((e=>e.response)))}))}(this,e)}getAlbum(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const r=`3/album/${t}`;return u(yield e.request({url:r}).catch((e=>e.response)))}))}(this,e)}getAccount(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const r=`3/account/${t}`;return u(yield e.plainRequest({url:r}).catch((e=>e.response)))}))}(this,e)}getAlbums(e,t){return function(e,t,i){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const r=`3/account/${t}/albums/${null!=i?i:""}`;return u(yield e.request({url:r}).catch((e=>e.response)))}))}(this,e,t)}getAlbumsIds(e,t){return function(e,t,i){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const r=`3/account/${t}/albums/ids/${null!=i?i:""}`;return u(yield e.request({url:r}).catch((e=>e.response)))}))}(this,e,t)}getGallery(e){return function(e,t=l){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const{pathname:r}=function(e){const t=Object.assign({},l,e);let r=`${t.section}`;t.sort&&(r+=`/${t.sort}`),"top"===t.section&&t.window&&(r+=`/${t.window}`),t.page&&(r+=`/${t.page}`);const i=new c.URL(`${n}/3/gallery/${r}`);return void 0!==t.showViral&&i.searchParams.append("showViral",t.showViral.toString()),void 0!==t.mature&&i.searchParams.append("mature",t.mature.toString()),void 0!==t.album_previews&&i.searchParams.append("album_previews",t.album_previews.toString()),i}(t),i=r.slice(1);return u(yield e.request({url:i}).catch((e=>e.response)))}))}(this,e)}getSubredditGallery(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const{pathname:r}=function(e){let t=`${e.subreddit}`;return e.sort&&(t+=`/${e.sort}`),"top"===e.sort&&e.window&&(t+=`/${e.window}`),e.page&&(t+=`/${e.page}`),new c.URL(`${n}/3/gallery/r/${t}`)}(t),i=r.slice(1);return u(yield e.request({url:i}).catch((e=>e.response)))}))}(this,e)}searchGallery(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const{pathname:r}=function(e){let t="";e.sort&&(t+=`/${e.sort}`),"top"===e.sort&&e.window&&(t+=`/${e.window}`),e.page&&(t+=`/${e.page}`);const r=new c.URL(`${n}/3/gallery/search${t}`);if(p.forEach((t=>{var i;(null===(i=e[t])||void 0===i?void 0:i.length)&&r.searchParams.append(t,e[t])})),!r.search){const t=e.q||e.query;if(!t)throw new Error("No query was provided");r.searchParams.append("q",t)}return r}(t),i=r.slice(1);return u(yield e.request({url:i}).catch((e=>e.response)))}))}(this,e)}getImage(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){const r=`3/image/${t}`;return u(yield e.request({url:r}).catch((e=>e.response)))}))}(this,e)}updateImage(e){return function(e,t){return(0,r.__awaiter)(this,void 0,void 0,(function*(){if("string"!=typeof(i=t).title&&"string"!=typeof i.description)throw new Error("Update requires a title and/or description");var i;const n=`3/image/${t.imageHash}`,a=d(t);return new Promise((t=>(0,r.__awaiter)(this,void 0,void 0,(function*(){return t(u(yield e.request({url:n,method:"POST",data:a,headers:a.getHeaders()}).catch((e=>e.response))))}))))}))}(this,e)}upload(e){return function(e,t){var i;return(0,r.__awaiter)(this,void 0,void 0,(function*(){const n=d(t),a=t.image,o="string"==typeof a?a:null!==(i=a.path)&&void 0!==i?i:a.name,s="stream"!==t.type||!o||-1===o.indexOf(".mp4")&&-1===o.indexOf(".avi")?"3/image":"3/upload";return new Promise((t=>(0,r.__awaiter)(this,void 0,void 0,(function*(){return t(u(yield e.request({url:s,method:"POST",data:n,headers:n.getHeaders(),onUploadProgress:t=>{e.emit("uploadProgress",Object.assign({},t))}}).catch((e=>e.response))))}))))}))}(this,e)}}const m=f;return t})()}));
